...
class UnshadedHttpTextFormat implements HttpTextFormat<SpanContext> {
  ...
  private final io.opentelemetry.context.propagation.TextMapPropagator shadedHttpTextFormat;

  UnshadedHttpTextFormat(
      final io.opentelemetry.context.propagation.TextMapPropagator shadedHttpTextFormat) {
