...
class UnshadedTracer implements Tracer {
  ...
  private static final Logger log = LoggerFactory.getLogger(UnshadedTracer.class);
  ...
  public HttpTextFormat<SpanContext> getHttpTextFormat() {
    return new UnshadedHttpTextFormat(OpenTelemetry.getPropagators().getTextMapPropagator());
  }
}
