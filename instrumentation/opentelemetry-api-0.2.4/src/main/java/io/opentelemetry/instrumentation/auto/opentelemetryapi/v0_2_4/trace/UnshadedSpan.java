...
import static io.opentelemetry.instrumentation.auto.opentelemetryapi.v0_2_4.trace.Bridging.toShaded;
import static io.opentelemetry.instrumentation.auto.opentelemetryapi.v0_2_4.trace.Bridging.toShadedOrNull;
...
class UnshadedSpan implements Span {
  ...
  private static final Logger log = LoggerFactory.getLogger(UnshadedSpan.class);
