 ...
 * @author Dhaval Doshi
 * @see <a href =
 *     "https://github.com/w3c/trace-context/blob/master/trace_context/HTTP_HEADER_FORMAT.md">Trace
 *     Context</a>
 *     <p>Implementations can add vendor specific details here.
 */
public class Tracestate {

  private static String KEY_WITHOUT_VENDOR_FORMAT = "[a-z][_0-9a-z\\-\\*\\/]{0,255}";
  private static String KEY_WITH_VENDOR_FORMAT =
      "[a-z][_0-9a-z\\-\\*\\/]{0,240}@[a-z][_0-9a-z\\-\\*\\/]{0,13}";
  private static String KEY_FORMAT = KEY_WITHOUT_VENDOR_FORMAT + "|" + KEY_WITH_VENDOR_FORMAT;
  private static String VALUE_FORMAT =
