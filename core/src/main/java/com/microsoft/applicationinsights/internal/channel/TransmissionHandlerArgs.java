...
/**
 * This class is used to store information between the transmission sender and the transmission
 * handlers
 *
 * <p>An example class that uses this are {@link
 * com.microsoft.applicationinsights.internal.channel.common.ErrorHandler}
 *
 * @author jamdavi
 */
public class TransmissionHandlerArgs {
  ...
  public void setTransmissionDispatcher(TransmissionDispatcher dispatcher) {
    this.transmissionDispatcher = dispatcher;
  }
   ...
   */
  public void setRetryHeader(Header head) {
    this.retryHeader = head;
  }
}
