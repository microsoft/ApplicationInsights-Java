 ...
 */
// this is a copy of the XStream class from version 1.4.11.1 with all Java 8 conditionals removed
// since those depend on classes that are removed during shading
// need to remove conditionals
public class Java7SaferXStream {
     ...
     * @throws InitializationException in case of an initialization problem
     */
    public Java7SaferXStream(ReflectionProvider reflectionProvider) {
     ...
     * @throws InitializationException in case of an initialization problem
     */
    public Java7SaferXStream(HierarchicalStreamDriver hierarchicalStreamDriver) {
     ...
     *             {@link #Java7SaferXStream(ReflectionProvider, HierarchicalStreamDriver, ClassLoader, Mapper)}
     *             instead
     */
    public Java7SaferXStream(
     ...
     *             {@link #Java7SaferXStream(ReflectionProvider, HierarchicalStreamDriver, ClassLoaderReference)}
     */
    public Java7SaferXStream(
            ReflectionProvider reflectionProvider, HierarchicalStreamDriver driver,
     ...
     * @since 1.3
     * @deprecated As of 1.4.5 use
     *             {@link #Java7SaferXStream(ReflectionProvider, HierarchicalStreamDriver, ClassLoaderReference, Mapper)}
     */
    public Java7SaferXStream(
            ReflectionProvider reflectionProvider, HierarchicalStreamDriver driver,
     ...
     * @since 1.3
     * @deprecated As of 1.4.5 use
     *             {@link #Java7SaferXStream(ReflectionProvider, HierarchicalStreamDriver, ClassLoaderReference, Mapper, ConverterLookup, ConverterRegistry)}
     */
    public Java7SaferXStream(
            ReflectionProvider reflectionProvider, HierarchicalStreamDriver driver,
     ...
     * @since 1.4.10
     */
    public static void setupDefaultSecurity(final Java7SaferXStream xstream) {
