...
/**
 * Created by Dhaval Doshi 10/31/2017 This class performs tests for
...
public class FixedRateSamplingTelemetryProcessorTest {
  ...
  public void dependencyTelemetryIsSubjectToSampling() {
    List<Telemetry> dependencyTelemetry =
        getListOfTelemetry(
            "com.microsoft.applicationinsights.telemetry.RemoteDependencyTelemetry", 100);
    List<Telemetry> dependencyTelemetry1 =
        getListOfTelemetry(
            "com.microsoft.applicationinsights.telemetry.RemoteDependencyTelemetry", 100);
  ...
  public void eventTelemetryIsSubjectToSampling() {
    List<Telemetry> dependencyTelemetry =
        getListOfTelemetry("com.microsoft.applicationinsights.telemetry.EventTelemetry", 100);
    List<Telemetry> dependencyTelemetry1 =
        getListOfTelemetry("com.microsoft.applicationinsights.telemetry.EventTelemetry", 100);
    List<Telemetry> itemsToSend = new ArrayList<Telemetry>();
    List<List<Telemetry>> telemetryListCollection = new ArrayList<List<Telemetry>>();
  ...
  public void exceptionTelemetryIsSubjectToSampling() {
    List<Telemetry> dependencyTelemetry =
        getListOfTelemetry("com.microsoft.applicationinsights.telemetry.ExceptionTelemetry", 100);
    List<Telemetry> dependencyTelemetry1 =
        getListOfTelemetry("com.microsoft.applicationinsights.telemetry.ExceptionTelemetry", 100);
    List<Telemetry> itemsToSend = new ArrayList<Telemetry>();
    List<List<Telemetry>> telemetryListCollection = new ArrayList<List<Telemetry>>();
  ...
  public void pageViewTelemetryIsSubjectToSampling() {
    List<Telemetry> dependencyTelemetry =
        getListOfTelemetry("com.microsoft.applicationinsights.telemetry.PageViewTelemetry", 100);
    List<Telemetry> dependencyTelemetry1 =
        getListOfTelemetry("com.microsoft.applicationinsights.telemetry.PageViewTelemetry", 100);
    List<Telemetry> itemsToSend = new ArrayList<Telemetry>();
    List<List<Telemetry>> telemetryListCollection = new ArrayList<List<Telemetry>>();
  ...
  public void requestTelemetryIsSubjectToSampling() {
    List<Telemetry> dependencyTelemetry =
        getListOfTelemetry("com.microsoft.applicationinsights.telemetry.RequestTelemetry", 100);
    List<Telemetry> dependencyTelemetry1 =
        getListOfTelemetry("com.microsoft.applicationinsights.telemetry.RequestTelemetry", 100);
    List<Telemetry> itemsToSend = new ArrayList<Telemetry>();
    List<List<Telemetry>> telemetryListCollection = new ArrayList<List<Telemetry>>();
  ...
  public void traceTelemetryIsSubjectToSampling() {
    List<Telemetry> dependencyTelemetry =
        getListOfTelemetry("com.microsoft.applicationinsights.telemetry.TraceTelemetry", 100);
    List<Telemetry> dependencyTelemetry1 =
        getListOfTelemetry("com.microsoft.applicationinsights.telemetry.TraceTelemetry", 100);
    List<Telemetry> itemsToSend = new ArrayList<Telemetry>();
    List<List<Telemetry>> telemetryListCollection = new ArrayList<List<Telemetry>>();
  ...
  public void metricTelemetryIsNotSubjectToSampling() {
    List<Telemetry> dependencyTelemetry =
        getListOfTelemetry("com.microsoft.applicationinsights.telemetry.MetricTelemetry", 100);
    List<Telemetry> itemsToSend = new ArrayList<Telemetry>();
    List<List<Telemetry>> telemetryListCollection = new ArrayList<List<Telemetry>>();
    telemetryListCollection.add(dependencyTelemetry);
    TelemetryConfiguration configuration = createConfiguration(itemsToSend);
  ...
  public void performanceCounterTelemetryIsNotSubjectToSampling() {
    List<Telemetry> dependencyTelemetry =
        getListOfTelemetry(
            "com.microsoft.applicationinsights.telemetry.PerformanceCounterTelemetry", 100);
    List<Telemetry> itemsToSend = new ArrayList<Telemetry>();
    List<List<Telemetry>> telemetryListCollection = new ArrayList<List<Telemetry>>();
    telemetryListCollection.add(dependencyTelemetry);
    TelemetryConfiguration configuration = createConfiguration(itemsToSend);
  ...
  public void sessionStateTelemetryIsNotSubjectToSampling() {
    List<Telemetry> dependencyTelemetry =
        getListOfTelemetry(
            "com.microsoft.applicationinsights.telemetry.SessionStateTelemetry", 100);
    List<Telemetry> itemsToSend = new ArrayList<Telemetry>();
    List<List<Telemetry>> telemetryListCollection = new ArrayList<List<Telemetry>>();
    telemetryListCollection.add(dependencyTelemetry);
    TelemetryConfiguration configuration = createConfiguration(itemsToSend);
    ...
    try {
      for (int i = 0; i < count; ++i) {
        if (type.contains("Exception")) {
          telemetryList.add(
              (Telemetry)
                  Class.forName(type).getConstructor(Throwable.class).newInstance(new Throwable()));
        } else {
  ...
  private void testSampling(
      ...
      List<List<Telemetry>> dependencyTelemetry,
      List<Telemetry> itemsToSend,
      List<String> includeTypes,
      List<String> excludeTypes,
      double samplingRate) {
    ...
    Assert.assertEquals(
        (Double) samplingRate, ((SupportSampling) itemsToSend.get(0)).getSamplingPercentage());
