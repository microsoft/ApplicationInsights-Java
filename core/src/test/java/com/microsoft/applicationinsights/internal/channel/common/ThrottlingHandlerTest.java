...
public class ThrottlingHandlerTest {
  ...
  public void pass429StatusGoodValue() {
    boolean result =
        generateTransmissionWithStatusCodeAndHeader(429, "Sun, 11 Feb 2018 16:51:18 GMT");
    Assert.assertTrue(result);
  }
  ...
  public void pass439StatusGoodValue() {
    boolean result =
        generateTransmissionWithStatusCodeAndHeader(439, "Sun, 11 Feb 2018 16:51:18 GMT");
    Assert.assertTrue(result);
  }
}
