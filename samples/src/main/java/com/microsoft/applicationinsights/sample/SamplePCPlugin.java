...
/**
 * A sample for creating a concrete plugin that will be called before and after Performance Counters
 * are collected.
 *
 * <p>To activate this class you need to add it to the ApplicationInsights.xml configuration file
 * with the 'Plugin' tag:
 *
 * <pre>{@code
 * 		<PerformanceCounters>
