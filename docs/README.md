...
- A requested profile duration (from the portal, JMX, or a file trigger) is honored but clamped to
  `continuousProfilingMaxAgeSeconds`, since the circular buffer cannot retain more than that.
