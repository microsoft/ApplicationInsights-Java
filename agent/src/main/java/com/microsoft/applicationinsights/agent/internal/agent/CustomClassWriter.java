...
/**
 * This class overwrites default class writer of ASM to use the ClassLoader provided by
 * DefaultByteCode transformer (This loader essentially has all the required classes already loaded)
 */
public class CustomClassWriter extends org.objectweb.asm.ClassWriter {
  ...
  /**
   * This method returns common super class for both the classes without actually loading the class
   * using forName(). If no super class is present it returns java/lang/Object class.
   *
   * @param type1
   * @param type2
