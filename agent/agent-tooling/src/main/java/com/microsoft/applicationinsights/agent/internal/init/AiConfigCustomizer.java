...
public class AiConfigCustomizer implements Function<ConfigProperties, Map<String, String>> {
  ...
  private static void enableInstrumentations(Configuration config, Map<String, String> properties) {
    ...
    if (config.instrumentation.micrometer.enabled) {
      ...
      // this is the actuator instrumentation for micrometer 1.0
      properties.put("otel.instrumentation.ai-actuator-metrics.enabled", "true");
      // this is the actuator instrumentation for micrometer 1.5
    ...
    if (namespace != null) {
      // this is used by Micrometer 1.0 instrumentation
