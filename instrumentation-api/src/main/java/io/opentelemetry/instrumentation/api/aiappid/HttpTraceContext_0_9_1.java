...
// included here in source for easy comparison to AiHttpTraceContext
public class HttpTraceContext_0_9_1 implements TextMapPropagator {
  private static final Logger logger = Logger.getLogger(HttpTraceContext_0_9_1.class.getName());
  ...
  private static final HttpTraceContext_0_9_1 INSTANCE = new HttpTraceContext_0_9_1();
  ...
  private HttpTraceContext_0_9_1() {
    // singleton
  }

  public static HttpTraceContext_0_9_1 getInstance() {
    return INSTANCE;
  }
