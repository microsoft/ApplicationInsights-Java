...
public class LogTelemetryClientProxyTests {
    ...
    private ITelemetryClient telemetryClientMock;
    ...
    @Before
    public void Before() {
        this.telemetryClientMock = mock(ITelemetryClient.class);
    ...
    private void setupTelemetryClientMock(List<Telemetry> telemetries) {
