...
public final class ConnectionString {
   ...
   * </pre>
   *
   * <p>If the connection string has already been set then this method logs a warning and does If
   * the connection string has already been set then this method logs a warning and does nothing.
   */
