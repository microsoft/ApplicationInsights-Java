...
* Enable agentmain to support loading Java Codeless Agent programmatically not via the jvm arguments [#1680](https://github.com/microsoft/ApplicationInsights-Java/issues/1680).
