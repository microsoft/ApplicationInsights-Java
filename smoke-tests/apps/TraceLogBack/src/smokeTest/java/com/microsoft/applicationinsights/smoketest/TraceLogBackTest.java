...
abstract class TraceLogBackTest {
  ...
  void testTraceLogBack() throws Exception {
    ...
    SmokeTestExtension.assertParentChild(
        rd, rdEnvelope, mdEnvelope1, "GET /TraceLogBack/traceLogBack");
    SmokeTestExtension.assertParentChild(
        rd, rdEnvelope, mdEnvelope2, "GET /TraceLogBack/traceLogBack");
  }
  ...
  static class Tomcat8Java20Test extends TraceLogBackTest {}
