...
@UseAgent
abstract class ClassicSdkLogbackInterop2xTest {
  ...
  void test() throws Exception {
    ...
    SmokeTestExtension.assertParentChild(
        rd, rdEnvelope, mdEnvelope1, "GET /ClassicSdkLogbackInterop2x/test");
    SmokeTestExtension.assertParentChild(
        rd, rdEnvelope, mdEnvelope2, "GET /ClassicSdkLogbackInterop2x/test");
  }
  ...
  void testWithException() throws Exception {
    ...
    SmokeTestExtension.assertParentChild(
        rd, rdEnvelope, edEnvelope, "GET /ClassicSdkLogbackInterop2x/testWithException");
  }

  @Environment(TOMCAT_8_JAVA_8)
  static class Tomcat8Java8Test extends ClassicSdkLogbackInterop2xTest {}

  @Environment(TOMCAT_8_JAVA_8_OPENJ9)
  static class Tomcat8Java8OpenJ9Test extends ClassicSdkLogbackInterop2xTest {}

  @Environment(TOMCAT_8_JAVA_11)
  static class Tomcat8Java11Test extends ClassicSdkLogbackInterop2xTest {}

  @Environment(TOMCAT_8_JAVA_11_OPENJ9)
  static class Tomcat8Java11OpenJ9Test extends ClassicSdkLogbackInterop2xTest {}

  @Environment(TOMCAT_8_JAVA_17)
  static class Tomcat8Java17Test extends ClassicSdkLogbackInterop2xTest {}

  @Environment(TOMCAT_8_JAVA_17_OPENJ9)
  static class Tomcat8Java17OpenJ9Test extends ClassicSdkLogbackInterop2xTest {}

  @Environment(TOMCAT_8_JAVA_21)
  static class Tomcat8Java21Test extends ClassicSdkLogbackInterop2xTest {}

  @Environment(TOMCAT_8_JAVA_21_OPENJ9)
  static class Tomcat8Java21OpenJ9Test extends ClassicSdkLogbackInterop2xTest {}

  @Environment(TOMCAT_8_JAVA_23)
  static class Tomcat8Java23Test extends ClassicSdkLogbackInterop2xTest {}

  @Environment(TOMCAT_8_JAVA_23_OPENJ9)
  static class Tomcat8Java23OpenJ9Test extends ClassicSdkLogbackInterop2xTest {}

  @Environment(WILDFLY_13_JAVA_8)
  static class Wildfly13Java8Test extends ClassicSdkLogbackInterop2xTest {}

  @Environment(WILDFLY_13_JAVA_8_OPENJ9)
  static class Wildfly13Java8OpenJ9Test extends ClassicSdkLogbackInterop2xTest {}
}
