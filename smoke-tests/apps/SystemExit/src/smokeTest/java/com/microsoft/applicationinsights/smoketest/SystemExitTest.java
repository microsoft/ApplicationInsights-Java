...
abstract class SystemExitTest {
  ...
  @Environment(JAVA_20)
  static class JavaLatestTest extends SystemExitTest {}

  @Environment(JAVA_20_OPENJ9)
  static class JavaLatestOpenJ9Test extends SystemExitTest {}

  @Environment(JAVA_21)
  static class JavaPrereleaseTest extends SystemExitTest {}
}
