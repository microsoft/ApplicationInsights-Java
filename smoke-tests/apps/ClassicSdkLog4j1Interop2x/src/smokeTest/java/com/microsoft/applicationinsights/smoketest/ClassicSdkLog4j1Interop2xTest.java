...
@UseAgent
abstract class ClassicSdkLog4j1Interop2xTest {

  @RegisterExtension static final SmokeTestExtension testing = SmokeTestExtension.create();

  private static final Logger logger = LogManager.getLogger(ClassicSdkLog4j1Interop2xTest.class);
  ...
  void test() throws Exception {
    ...
    SmokeTestExtension.assertParentChild(
        rd, rdEnvelope, mdEnvelope1, "GET /ClassicSdkLog4j1Interop2x/test");
    SmokeTestExtension.assertParentChild(
        rd, rdEnvelope, mdEnvelope2, "GET /ClassicSdkLog4j1Interop2x/test");
    SmokeTestExtension.assertParentChild(
        rd, rdEnvelope, mdEnvelope3, "GET /ClassicSdkLog4j1Interop2x/test");
  }
  ...
  void testWithException() throws Exception {
    ...
    SmokeTestExtension.assertParentChild(
        rd, rdEnvelope, edEnvelope, "GET /ClassicSdkLog4j1Interop2x/testWithException");
  }

  @Environment(TOMCAT_8_JAVA_8)
  static class Tomcat8Java8Test extends ClassicSdkLog4j1Interop2xTest {}

  @Environment(TOMCAT_8_JAVA_8_OPENJ9)
  static class Tomcat8Java8OpenJ9Test extends ClassicSdkLog4j1Interop2xTest {}

  @Environment(TOMCAT_8_JAVA_11)
  static class Tomcat8Java11Test extends ClassicSdkLog4j1Interop2xTest {}

  @Environment(TOMCAT_8_JAVA_11_OPENJ9)
  static class Tomcat8Java11OpenJ9Test extends ClassicSdkLog4j1Interop2xTest {}

  @Environment(TOMCAT_8_JAVA_17)
  static class Tomcat8Java17Test extends ClassicSdkLog4j1Interop2xTest {}

  @Environment(TOMCAT_8_JAVA_17_OPENJ9)
  static class Tomcat8Java17OpenJ9Test extends ClassicSdkLog4j1Interop2xTest {}

  @Environment(TOMCAT_8_JAVA_21)
  static class Tomcat8Java21Test extends ClassicSdkLog4j1Interop2xTest {}

  @Environment(TOMCAT_8_JAVA_21_OPENJ9)
  static class Tomcat8Java21OpenJ9Test extends ClassicSdkLog4j1Interop2xTest {}

  @Environment(TOMCAT_8_JAVA_23)
  static class Tomcat8Java23Test extends ClassicSdkLog4j1Interop2xTest {}

  @Environment(TOMCAT_8_JAVA_23_OPENJ9)
  static class Tomcat8Java23OpenJ9Test extends ClassicSdkLog4j1Interop2xTest {}

  @Environment(WILDFLY_13_JAVA_8)
  static class Wildfly13Java8Test extends ClassicSdkLog4j1Interop2xTest {}

  @Environment(WILDFLY_13_JAVA_8_OPENJ9)
  static class Wildfly13Java8OpenJ9Test extends ClassicSdkLog4j1Interop2xTest {}
}
