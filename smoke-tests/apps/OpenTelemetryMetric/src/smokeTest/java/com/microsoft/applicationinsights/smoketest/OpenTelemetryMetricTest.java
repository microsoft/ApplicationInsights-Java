...
abstract class OpenTelemetryMetricTest {
  ...
  private void validateHistogramMetric(String name) throws Exception {
    ...
    assertThat(envelope.getSampleRate()).isNull(); // metrics are never sent with sample rate
  ...
  static class Tomcat8Java17OpenJ9Test extends OpenTelemetryMetricTest {}

  @Environment(TOMCAT_8_JAVA_21)
  static class Tomcat8Java21Test extends OpenTelemetryMetricTest {}

  @Environment(TOMCAT_8_JAVA_21_OPENJ9)
  static class Tomcat8Java21OpenJ9Test extends OpenTelemetryMetricTest {}

  @Environment(TOMCAT_8_JAVA_23)
  static class Tomcat8Java23Test extends OpenTelemetryMetricTest {}

  @Environment(TOMCAT_8_JAVA_23_OPENJ9)
  static class Tomcat8Java23OpenJ9Test extends OpenTelemetryMetricTest {}
