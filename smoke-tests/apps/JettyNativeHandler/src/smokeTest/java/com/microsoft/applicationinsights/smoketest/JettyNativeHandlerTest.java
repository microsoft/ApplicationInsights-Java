...
abstract class JettyNativeHandlerTest {
  ...
  @Environment(JAVA_20)
  static class JavaLatestTest extends JettyNativeHandlerTest {}

  @Environment(JAVA_20_OPENJ9)
  static class JavaLatestOpenJ9Test extends JettyNativeHandlerTest {}

  @Environment(JAVA_21)
  static class JavaPrereleaseTest extends JettyNativeHandlerTest {}
}
