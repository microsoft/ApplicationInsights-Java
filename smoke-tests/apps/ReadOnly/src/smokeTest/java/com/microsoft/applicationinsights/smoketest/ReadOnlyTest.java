...
abstract class ReadOnlyTest {
  ...
  @Environment(JAVA_20)
  static class JavaLatestTest extends ReadOnlyTest {}

  @Environment(JAVA_20_OPENJ9)
  static class JavaLatestOpenJ9Test extends ReadOnlyTest {}

  @Environment(JAVA_21)
  static class JavaPrereleaseTest extends ReadOnlyTest {}
}
