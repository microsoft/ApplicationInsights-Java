...
abstract class Log4j2Test {
  ...
  void testWithNullException() throws Exception {
    ...
    SmokeTestExtension.assertParentChild(
        rd, rdEnvelope, edEnvelope, "GET /Log4j2/testWithNullException");
  }
  ...
  static class Tomcat8Java17OpenJ9Test extends Log4j2Test {}

  @Environment(TOMCAT_8_JAVA_21)
  static class Tomcat8Java21Test extends Log4j2Test {}

  @Environment(TOMCAT_8_JAVA_21_OPENJ9)
  static class Tomcat8Java21OpenJ9Test extends Log4j2Test {}

  @Environment(TOMCAT_8_JAVA_23)
  static class Tomcat8Java23Test extends Log4j2Test {}

  @Environment(TOMCAT_8_JAVA_23_OPENJ9)
  static class Tomcat8Java23OpenJ9Test extends Log4j2Test {}
