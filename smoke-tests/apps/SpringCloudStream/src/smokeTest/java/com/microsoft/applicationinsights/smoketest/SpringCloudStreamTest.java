...
abstract class SpringCloudStreamTest {
  ...
  @Environment(JAVA_20)
  static class JavaLatestTest extends SpringCloudStreamTest {}

  @Environment(JAVA_20_OPENJ9)
  static class JavaLatestOpenJ9Test extends SpringCloudStreamTest {}

  @Environment(JAVA_21)
  static class JavaPrereleaseTest extends SpringCloudStreamTest {}
}
