...
abstract class WebFluxTest {
  ...
  @Environment(JAVA_20)
  static class JavaLatestTest extends WebFluxTest {}

  @Environment(JAVA_20_OPENJ9)
  static class JavaLatestOpenJ9Test extends WebFluxTest {}

  @Environment(JAVA_21)
  static class JavaPrereleaseTest extends WebFluxTest {}
}
