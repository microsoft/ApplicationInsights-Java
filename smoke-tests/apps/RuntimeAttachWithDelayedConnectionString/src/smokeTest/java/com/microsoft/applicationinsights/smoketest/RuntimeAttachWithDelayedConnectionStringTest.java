...
abstract class RuntimeAttachWithDelayedConnectionStringTest {
  ...
  @Environment(JAVA_20)
  static class JavaLatestTest extends RuntimeAttachWithDelayedConnectionStringTest {}

  @Environment(JAVA_20_OPENJ9)
  static class JavaLatestOpenJ9Test extends RuntimeAttachWithDelayedConnectionStringTest {}
