...
abstract class NonDaemonThreadsTest {
  ...
  @Environment(JAVA_20)
  static class JavaLatestTest extends NonDaemonThreadsTest {}

  @Environment(JAVA_20_OPENJ9)
  static class JavaLatestOpenJ9Test extends NonDaemonThreadsTest {}

  @Environment(JAVA_21)
  static class JavaPrereleaseTest extends NonDaemonThreadsTest {}
}
