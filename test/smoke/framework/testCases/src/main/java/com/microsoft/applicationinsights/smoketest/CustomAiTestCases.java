...
public class CustomAiTestCases {
  ...
  public Runnable getTrackEvent(
      final String name, final Map<String, String> properties, final Map<String, Double> metrics) {
    return new Runnable() {
      @Override
      public void run() {
  ...
  public Runnable getTrackTrace(
      final String message, final SeverityLevel severityLevel, Map<String, String> properties) {
    return new Runnable() {
      @Override
      public void run() {
  ...
  public Runnable getTrackException(
      final Exception exception, Map<String, String> properties, Map<String, Double> metrics) {
    return new Runnable() {
      @Override
      public void run() {
