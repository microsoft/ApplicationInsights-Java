...
public abstract class AiSmokeTest {
	...
	protected static void waitForApplicationToStart() throws Exception {
		...
		// TODO conditionally ignore request telemetry generated by request capture.
		System.out.printf("Waiting %ds for any request telemetry...%n", TELEMETRY_RECEIVE_TIMEOUT_SECONDS);
