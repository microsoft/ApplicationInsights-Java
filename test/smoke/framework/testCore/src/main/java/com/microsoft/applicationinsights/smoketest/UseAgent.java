 ...
 *
 * <p>The configuration files should be placed in {@code /test/smoke/appServers/global-resources/{mode}_ApplicationInsights.json}.</p>
 *
 * <p>
 *     The {mode} prefix differentiates the configurations for various purposes and the mode is selected by the
 *     {@link #value()} in this annotation. For example, a configuration file named {@code myconfig_ApplicationInsights.json}
 ...
 *     and renamed to {@code ApplicationInsights.json}.
 * </p>
 */
