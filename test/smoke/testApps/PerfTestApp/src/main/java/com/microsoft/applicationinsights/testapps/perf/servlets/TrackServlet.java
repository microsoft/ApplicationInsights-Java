...
public class TrackServlet extends APerfTestServlet {
  ...
  private final Map<String, TestCaseRunnableFactory> factoryMap =
      new HashMap<String, TestCaseRunnableFactory>() {
        {
          put(
              "metric",
              new TestCaseRunnableFactory("trackMetric") {
                @Override
          ...
          put(
              "event",
              new TestCaseRunnableFactory("trackEvent") {
                @Override
          ...
          put(
              "httpRequest",
              new TestCaseRunnableFactory("trackHttpRequest") {
                @Override
                protected Runnable getRunnable() {
          ...
          put(
              "dependency",
              new TestCaseRunnableFactory("trackDependency") {
                @Override
                protected Runnable getRunnable() {
          ...
          put(
              "trace",
              new TestCaseRunnableFactory("trackTrace") {
                @Override
                protected Runnable getRunnable() {
          ...
          put(
              "exception",
              new TestCaseRunnableFactory("trackException") {
                @Override
                protected Runnable getRunnable() {
          ...
          put(
              "pageView",
              new TestCaseRunnableFactory("trackPageView") {
                @Override
                protected Runnable getRunnable() {
