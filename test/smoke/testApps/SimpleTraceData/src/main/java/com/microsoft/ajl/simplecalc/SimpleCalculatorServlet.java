...
public class SimpleCalculatorServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		new TelemetryClient().trackTrace("This is first trace message.");

		new TelemetryClient().trackTrace("This is second trace message.", SeverityLevel.Error);

		Map<String, String> properties = new ConcurrentHashMap<>();
		properties.put("key", "Test");
		new TelemetryClient().trackTrace("This is third trace message.", SeverityLevel.Information, properties);
