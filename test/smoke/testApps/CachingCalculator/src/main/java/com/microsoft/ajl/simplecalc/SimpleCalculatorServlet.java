...
import static com.microsoft.ajl.simplecalc.ParameterConstants.LEFT_OPERAND;
import static com.microsoft.ajl.simplecalc.ParameterConstants.OPERATOR;
import static com.microsoft.ajl.simplecalc.ParameterConstants.RIGHT_OPERAND;
...
public class SimpleCalculatorServlet extends HttpServlet {
  ...
  private static double parseParamOrThrow(String param, String errMsgFmt)
    ...
    try {
      ...
      throw new CalculatorParameterException(
          String.format("Left operand is not a number: %s", param), e);
    }
  }
