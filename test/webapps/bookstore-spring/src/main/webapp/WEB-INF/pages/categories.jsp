...
<body background="./resources/Books.jpg">
    ...
    <table align="center" style="background-color: wheat; border:4px solid darkred; font-size: 24px" cellspacing="30" cellpadding="20">
        <c:forEach var="category" items="${categories}" varStatus="loopStatus">
            <tr bgcolor="${loopStatus.index % 2 == 0 ? '#aaaaaa' : '#cccccc'}">
                <td align="center"><a href='books?id=<c:out value="${category}"/>'><c:out value="${category}"/></a></td>
            </tr>
        </c:forEach>
    </table>
</body>
