...
public class WebSessionTelemetryInitializerTests {
  ...
  private WebSessionTelemetryInitializer sessionTelemetryInitializer =
  ...
  public void testIsFirstSessionSetWhenRequired() {
    ...
    Assert.assertEquals(
        "First session expected.", true, telemetry.getContext().getSession().getIsFirst());
  }
