...
hideFromDependabot(":agent:instrumentation:micrometer-1.5")
include(":agent:agent")
...
hideFromDependabot(":smoke-tests:apps:Micrometer1_0")
hideFromDependabot(":smoke-tests:apps:Micrometer1_5")
