...
hideFromDependabot(":smoke-tests:apps:TraceJavaUtilLoggingUsingAgent")
hideFromDependabot(":smoke-tests:apps:TraceLog4j1_2")
hideFromDependabot(":smoke-tests:apps:TraceLog4j1_2UsingAgent")
hideFromDependabot(":smoke-tests:apps:TraceLog4j2")
hideFromDependabot(":smoke-tests:apps:TraceLog4j2UsingAgent")
hideFromDependabot(":smoke-tests:apps:TraceLogBack")
hideFromDependabot(":smoke-tests:apps:TraceLogBackUsingAgent")
